...
ggplot(raw_data, aes(x = Gender)) + geom_histogram(stat = "count")
ggplot(raw_data, aes(x = Gender, y = Age)) + geom_point()
...
```{r}
ggplot(country_leave, aes(x = Country, y = leave)) + geom_bar(stat = "identity", aes(fill = leave)) + coord_flip()
```